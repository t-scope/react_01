...
const TransactionMenu = ({dailyTransactions,currentDay,onAddTransactionForm,isEntryDrwarOpen,onSelectTransaction}:TransactionMenuProps) => {
                      ...
                      sx={{
                        ...
                        backgroundColor: (theme) =>{
                          if(transaction.type == "income"){
                            return theme.palette.incomeColor.light
                          }else{
                            return theme.palette.expenseColor.light
                          }
